...
const projects = [
   ...
   /*PowerBI*/
  {
    ...
    shortDesc: 'Interactive sales dashboard with Power BI.',
    longDesc: 'Detailed Power BI reports for sales performance and trends.',
    highlights: [
      'Interactive charts',
      'Filters',
      'Monthly trends'
    ],
    link: 'https://example.com/powerbi-sales',
  ...
  /*Pandas*/
{
  id: generateId(),
  category: 'pandas',
  title: 'Customer Segmentation with Pandas',
  shortDesc: 'Segments customers based on RFM analysis using Pandas.',
  longDesc: 'This project uses Python and Pandas to perform RFM (Recency, Frequency, Monetary) analysis on e-commerce transaction data. The goal is to group customers into segments like VIP, Loyal, and At-risk based on behavior.',
  highlights: [
  ...
  link: 'https://github.com/yourusername/customer-segmentation-pandas',
  ...
  alt: 'Customer Segmentation with Pandas'
},
/*Python*/
{
  id: generateId(),
...
function loadProjects(category) {
  projectsWrapper.innerHTML = ''; // Temizle
